...
@RestController
@RequestMapping("/api/wineStyle")
@Tag(name = "Wine_Style", description = "Endpoints for managing wine style")
public class WineStyleController {
    private final WineStyleService service;
    @Operation(summary = "Get wine style", description = "Returns a list of all wine style")
    @ApiResponse(responseCode = "200", description = "Wine style successfully retrieved")
    @ApiResponse(
            responseCode = "500",
